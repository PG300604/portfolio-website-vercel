...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="py-32 bg-[var(--bg-main)] relative z-10 border-t border-[var(--border-subtle)]">
          ...
          {certs.map((cert, idx) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div>
                  <span className="font-mono-custom text-xs text-[var(--text-muted)] block mb-1">
                    [ 0{idx + 1} ]
                  </span>
                  <h3 className="text-xl font-sora font-bold text-[var(--text-main)]">
                    {cert.name}
                  </h3>
                </div>
                {cert.featured && (
                  <span className="font-mono-custom text-[10px] uppercase font-bold bg-[var(--text-main)] text-[var(--bg-main)] px-3 py-1 rounded-full">
                    [ FEATURED ]
                  </span>
                )}
              </div>

              <div className="font-mono-custom text-xs text-[var(--text-muted)] space-y-1.5 mb-6">
              ...
              {cert.credentialId && (
                <div className="font-mono-custom text-[11px] text-[var(--text-muted)] pt-4 border-t border-[var(--border-subtle)]">
